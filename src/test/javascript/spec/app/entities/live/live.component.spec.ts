  ...
  describe('Live Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LiveComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.lives && comp.lives[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
