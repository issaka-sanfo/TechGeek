...
describe('Service Tests', () => {
  describe('Live Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(LiveService);
      httpMock = injector.get(HttpTestingController);
      currentDate = moment();

      elemDefault = new Live(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', currentDate, currentDate, false);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Live', () => {
        ...
        service.create(new Live()).subscribe(resp => (expectedResult = resp.body));
