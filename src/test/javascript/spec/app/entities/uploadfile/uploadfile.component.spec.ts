...
import { UploadfileComponent } from 'app/entities/uploadfile/uploadfile.component';
...
describe('Component Tests', () => {
  describe('Uploadfile Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.uploadfiles && comp.uploadfiles[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
