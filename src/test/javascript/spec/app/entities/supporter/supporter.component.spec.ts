...
import { SupporterComponent } from 'app/entities/supporter/supporter.component';
...
describe('Component Tests', () => {
  describe('Supporter Management Component', () => {
    let comp: SupporterComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SupporterComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.supporters && comp.supporters[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
