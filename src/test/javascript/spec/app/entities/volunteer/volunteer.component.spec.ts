...
import { VolunteerComponent } from 'app/entities/volunteer/volunteer.component';
...
describe('Component Tests', () => {
  describe('Volunteer Management Component', () => {
    let comp: VolunteerComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(VolunteerComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.volunteers && comp.volunteers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
