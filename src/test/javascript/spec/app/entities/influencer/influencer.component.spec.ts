...
import { InfluencerComponent } from 'app/entities/influencer/influencer.component';
...
describe('Component Tests', () => {
  describe('Influencer Management Component', () => {
    let comp: InfluencerComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(InfluencerComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.influencers && comp.influencers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
