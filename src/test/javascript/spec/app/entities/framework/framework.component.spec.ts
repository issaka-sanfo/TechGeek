...
import { FrameworkComponent } from 'app/entities/framework/framework.component';
...
describe('Component Tests', () => {
  describe('Framework Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.frameworks && comp.frameworks[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
