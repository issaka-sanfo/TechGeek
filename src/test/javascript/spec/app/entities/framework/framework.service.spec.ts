...
describe('Service Tests', () => {
  describe('Framework Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(FrameworkService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Framework(0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Framework', () => {
        ...
        service.create(new Framework()).subscribe(resp => (expectedResult = resp.body));
