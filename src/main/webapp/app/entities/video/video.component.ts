...
export class VideoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.videoService
      ...
      .subscribe(
        (res: HttpResponse<IVideo[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInVideos(): void {
    this.eventSubscriber = this.eventManager.subscribe('videoListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IVideo[] | null, headers: HttpHeaders, page: number): void {
