...
/**
 * REST controller for managing {@link com.epita.techgeek.domain.Uploadfile}.
 */
@RestController
@RequestMapping("/api")
public class UploadfileResource {
    ...
    /**
     * {@code POST  /uploadfiles} : Create a new uploadfile.
     *
    ...
    public ResponseEntity<UploadfileDTO> createUploadfile(@RequestBody UploadfileDTO uploadfileDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/uploadfiles/" + result.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, result.getId().toString()))
            .body(result);
    }

    /**
     * {@code PUT  /uploadfiles} : Updates an existing uploadfile.
     *
    ...
    public ResponseEntity<UploadfileDTO> updateUploadfile(@RequestBody UploadfileDTO uploadfileDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, uploadfileDTO.getId().toString()))
            .body(result);
    }

    /**
     * {@code GET  /uploadfiles} : get all the uploadfiles.
     *
    ...
    public ResponseEntity<List<UploadfileDTO>> getAllUploadfiles(UploadfileCriteria criteria, Pageable pageable) {
        log.debug("REST request to get Uploadfiles by criteria: {}", criteria);
        Page<UploadfileDTO> page = uploadfileQueryService.findByCriteria(criteria, pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(ServletUriComponentsBuilder.fromCurrentRequest(), page);
        return ResponseEntity.ok().headers(headers).body(page.getContent());
    }

    /**
     * {@code GET  /uploadfiles/count} : count all the uploadfiles.
     *
     * @param criteria the criteria which the requested entities should match.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the count in body.
     */
    @GetMapping("/uploadfiles/count")
    ...
    /**
     * {@code GET  /uploadfiles/:id} : get the "id" uploadfile.
     *
    ...
    /**
     * {@code DELETE  /uploadfiles/:id} : delete the "id" uploadfile.
     *
     * @param id the id of the uploadfileDTO to delete.
     * @return the {@link ResponseEntity} with status {@code 204 (NO_CONTENT)}.
     */
    @DeleteMapping("/uploadfiles/{id}")
